...
bool s21_is_less(work_decimal num_1, work_decimal num_2) {
  bool res = true;
  if (s21_is_greater(num_1, num_2) || s21_is_equal(num_1, num_2)) {
    res = false;
  }
  return res;
}
...
bool s21_is_less_or_equal(work_decimal num_1, work_decimal num_2) {
  bool res = false;
  if (s21_is_less(num_1, num_2) || s21_is_equal(num_1, num_2)) {
    res = true;
  }
  return res;
}
...
bool s21_is_not_equal(work_decimal num_1, work_decimal num_2) {
  return (!s21_is_equal(num_1, num_2));
}