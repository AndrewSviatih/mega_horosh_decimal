...
Suite *suite_is_not_equal(void) {
  ...
  tcase_add_test(tc, is_not_equal_test1);
  tcase_add_test(tc, is_not_equal_test2);
  tcase_add_test(tc, is_not_equal_test3);
  tcase_add_test(tc, is_not_equal_test4);
  tcase_add_test(tc, is_not_equal_test5);
  tcase_add_test(tc, is_not_equal_test6);
  tcase_add_test(tc, is_not_equal_test7);
  tcase_add_test(tc, is_not_equal_test8);
  tcase_add_test(tc, is_not_equal_test9);
  tcase_add_test(tc, is_not_equal_test10);
  tcase_add_test(tc, is_not_equal_test11);
  tcase_add_test(tc, is_not_equal_test12);
  tcase_add_test(tc, is_not_equal_test13);
  tcase_add_test(tc, is_not_equal_test14);
  tcase_add_test(tc, is_not_equal_test15);
  tcase_add_test(tc, is_not_equal_test16);
  tcase_add_test(tc, is_not_equal_test17);
  tcase_add_test(tc, is_not_equal_test18);
  tcase_add_test(tc, is_not_equal_test19);
  tcase_add_test(tc, is_not_equal_test20);
  tcase_add_test(tc, is_not_equal_test21);
